...
% ---- Cơ chế thuật ngữ -------------------------------------------------
% \gd{khoa}{Tên hiển thị}  : định nghĩa một mục trong chương Thuật ngữ
% \g{khoa}{chữ hiển thị}   : mọi lần nhắc tới thuật ngữ, thành liên kết về chương đó
...
đều là một liên kết dẫn về chương~\ref{ch:thuatngu} (\emph{Thuật ngữ}) --- nơi thuật ngữ
đó được giải thích. Bạn có thể bấm vào bất kỳ từ nào chưa rõ để nhảy tới định nghĩa, rồi quay lại
